...
pred reemplazarChocolate[ch1, ch2: Chocolate, ca1, ca2: Caja]{
	/*ch1 esta en ca1 y ch2 no */
	(ch1 in ca1.chocolates) and (ch2 ! in ca1.chocolates) 
	/*Hay al menos 1 choco relleno y al menos 1 blanco*/
	and (#(ca1.chocolates & formato.Relleno) >=1) and (#(ca1.chocolates & ChocolateBlanco) <= 1) and 
	  --Postcondicion
