...
// aca tendria podria usar el = o in
...
fact H { 
	     all mb: MountainBike |
						(( mb.rod in Chico ) and  (tresCambios[mb] or seisCambios[mb] or doceCambios[mb] ) )or
...
pred doceCambios[b: Bicicleta] {
	...
	//( (#b.cambios = 3 ) and (b.cambios in Seis + Tres ) ) or PARA MI ESTA MAL YA QUE ESTO DA 9
