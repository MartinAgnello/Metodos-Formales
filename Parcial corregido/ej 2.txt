...
sig Estado {
	...
	ultimaActualizacion: some Actualizacion 		//CORRECCION INCISO 1:EN VEZ DE SOME
																													// TIENE Q IR LONE
	}
...
/*lo q esta en oendiente y en actualizacion no se comparten en nada
 y que las 2 pueden estar vacias*/
fact { all  e:Estado | (e.actualizacionesPendientes & e.ultimaActualizacion)=none or  
...
--CORRECCION PROFE:
pred RealizarUltimaActualizacion[e1,e2 : Estado]{
	//no hay actualizaciones prioritarias pendientes
	//precondiciones
	(e1.actualizacionesPendientes & Prioritaria) = none and
	(e1.ultimaActualizacion in (Actualizacion - Prioritaria)) and
	//postcondiciones
	(some a : (e1.actualizacionesPendientes) | e2.actualizacionesPendientes = 
	e1.actualizacionesPendientes - a and e2.ultimaActualizacion = a)	//esto ultimo puede ser = o - no tengo idea
	
	or
	//la ultima actulizacion es prioritaria
 	(
	//precondiciones
